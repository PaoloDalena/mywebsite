...
{{< icon name="r-project" pack="fab" >}} Check the website of my R package [{tastypie}](https://paolodalena.github.io/tastypie/) for
{{< icon name="chart-pie" pack="fas" >}} making easy pie charts with R! (available on [CRAN](https://cran.r-project.org/web/packages/tastypie/index.html))
